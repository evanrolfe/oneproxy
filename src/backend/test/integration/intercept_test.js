...
describe('The Intercept', () => {
  ...
  describe('Intercepting a request and its response', () => {
    it('works', async () => {
      ...
      expect(request.request_headers).to.eql('{"host":"localhost:3000","user-agent":"curl/7.58.0","accept":"*/*"}');
...
//       expect(request.modified_request_headers).to.eql('{"host":"localhost:3000","user-agent":"curl/1.2.3","accept":"*/*"}');
