...
class Ui_RequestsPage(object):
    def setupUi(self, RequestsPage):
        ...
        sizePolicy.setHeightForWidth(self.requestGroupsTreeView.sizePolicy().hasHeightForWidth())
        self.requestGroupsTreeView.setSizePolicy(sizePolicy)
        self.splitter.addWidget(self.requestGroupsTreeView)
