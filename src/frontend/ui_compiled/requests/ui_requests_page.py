...
class Ui_RequestsPage(object):
    def setupUi(self, RequestsPage):
        ...
        self.toggleFuzzTableButton = QPushButton(self.widget)
        ...
        self.requestTabs = QTabWidget(self.widget)
