...
class RequestView(QWidget):
  def __init__(self, *args, **kwargs):
    ...
    #self.highlighter = HtmlHighlighter(self.ui.responseBodyText.document())
  ...
  def set_request(self, request):
    ...
    self.ui.responseBodyText.setPlainText(request.response_body)
    self.ui.responseBodyWebview.setHtml(request.response_body_rendered)
